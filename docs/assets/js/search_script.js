...
!(function () {
  ...
  var f = {
    compile: function (r) {
      // Highlight matched terms by wrapping them in <span>
      ...
      return i.template.replace(i.pattern, function (t, e) {
        ...
        if (e === "title" || e === "description") {
          // Wrap matched input terms in span
          n = highlightSearchTerm(n || r[e] || t, r.query);
        }
    ...
    setOptions: function (t) {
      (i.pattern = t.pattern || i.pattern),
        ...
        "function" == typeof t.middleware && (i.middleware = i.middleware);
    },
  };
  ...
  !(function (t) {
    let i = {
        ...
        searchResultTemplate:
          '<li><div class="link-container"><a href="{url}" title="{desc}"><div class="link-title">{title}</div><p>{description}</p></a></div></li>',
